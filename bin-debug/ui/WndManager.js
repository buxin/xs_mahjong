...
(function (WIN_EFFECT) {
    ...
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_CLOSE_SHRINK"] = 7] = "EFFECT_WIN_CLOSE_SHRINK";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_CLOSE_END"] = 8] = "EFFECT_WIN_CLOSE_END";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_MOVE_LEFT"] = 9] = "EFFECT_WIN_OPEN_MOVE_LEFT";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_MOVE_RIGHT"] = 10] = "EFFECT_WIN_OPEN_MOVE_RIGHT";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_MOVE_UP"] = 11] = "EFFECT_WIN_OPEN_MOVE_UP";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_MOVE_DOWN"] = 12] = "EFFECT_WIN_OPEN_MOVE_DOWN";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_SCALE"] = 13] = "EFFECT_WIN_OPEN_SCALE";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_ALPHA"] = 14] = "EFFECT_WIN_OPEN_ALPHA";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_ENLARGE"] = 15] = "EFFECT_WIN_OPEN_ENLARGE";
    WIN_EFFECT[WIN_EFFECT["EFFECT_WIN_OPEN_END"] = 16] = "EFFECT_WIN_OPEN_END";
        ...
        if (efect == null || efect == 0) {
            ...
            switch (efect) {
                ...
                case WIN_EFFECT.EFFECT_WIN_OPEN_ALPHA:
                    wnd.alpha = 0.5;
                    break;
                case WIN_EFFECT.EFFECT_WIN_OPEN_ENLARGE:
                    wnd.x = WndManager.root.stage.stageWidth / 2;
                    // wnd.y = WndManager.root.stage.stageHeight / 2;
                    wnd.scaleX = 0;
                    wnd.scaleY = 0;
                    easeVal = egret.Ease.backInOut;
                    timer = 500;
                    break;
            }
            egret.Tween.get(wnd).to({ x: 0, y: 0, scaleX: 1, scaleY: 1, alpha: 1 }, timer, easeVal);
        }
            ...
            switch (efect) {
                ...
                case WIN_EFFECT.EFFECT_WIN_CLOSE_ALPHA:
                    ...
                    nAlpha = 0;
                    break;
                case WIN_EFFECT.EFFECT_WIN_CLOSE_SHRINK:
                    nX = WndManager.root.stage.stageWidth / 2;
                    nY = WndManager.root.stage.stageHeight;
                    nScaleX = 0;
                    nScaleY = 0;
                    nAlpha = 1;
            ...
            egret.Tween.get(wnd).to({ x: nX, y: nY, scaleX: nScaleX, scaleY: nScaleY, alpha: nAlpha }, 500, ease).call(function () {
                if (openType == WIN_OPERATOR.WIN_CLOSE_HIDE) {
                    wnd.visible = false;
                }
                else if (openType == WIN_OPERATOR.WIN_CLOSE_DELETE) {
